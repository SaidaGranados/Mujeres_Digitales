...
ESTA CARPETA NO TIENE CODIGO UNICAMENTE DEL ARCHIVO app.js PARA MOSTRAR COMO SE CONFIGURACION UN SERVIDOR.CABE ACLARAR QUE
DURANTE LA CONFIGURACIÓN DE NODE NO SE INCLUYÓ EL REPOSITORIO DEL BACKEND YAQUE AUN NO SE HA CREADO
