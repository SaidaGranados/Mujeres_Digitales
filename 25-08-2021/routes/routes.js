...
app.post('/enviarcorreo',function(request,response){
    ...
    var transporter = nodemailer.createTransport({
        ...
        requireTLS: true,
        auth: {
          user: 'pruebassaida323@gmail.com', // cuenta cualquiera
          pass: 'zevixwimkasdjxld' // contraseña generada
        }
    });
    
      // Configuración del correo y contraseña
    var mailOptions = {
        from: 'pruebassaida323@gmail.com', // email de quien envía el correo - remitente
        to: 'srgranados3@misena.edu.co', // email de quien recibe el correo - receptor
